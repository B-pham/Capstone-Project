...
public class QuizSaver : MonoBehaviour
{
    ...
    [SerializeField] private string[] sheetFields = {"`Quiz Name` varchar(255), `Quiz Type` varchar(50), `Randomize Question Order` varchar(5), `Randomize Answer Order` varchar(5)", //Settings data fields
                                    "`Question` varchar(255), `Choose Multiple?` varchar(5), `Highlight?` varchar(5), `Highlighted Object` varchar(255), `Options` varchar(255), `Correct Answer` varchar(255)"}; //Quiz Data fields
    ...
    private DataTable createSettingTable(QuizObj quiz)
    {
        ...
        dtColumn = createColumn("System.String", "Quiz Type");
        settingsTable.Columns.Add(dtColumn);
